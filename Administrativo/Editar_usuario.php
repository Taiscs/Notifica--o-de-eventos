...
?>.
       ...
       <br><a href="sair.php">Sair</a> <br><a href="cadastrarusuario.php">Cadastrar usuário</a> 
       <br><a href="usuarios.php">Ver Usuários cadastrados</a> <br>
       <br><a href="usuarios.php">Ver Eventos notificados</a> <br>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="">
            ...
            <input type="hidden" class="form-control" id="recipientid" name = "id">
